...
const serviceImagePool = ['/i1.jpeg', '/i2.jpeg', '/i3.jpeg', '/i4.jpeg', '/i5.jpeg', '/i6.jpeg', '/i7.jpeg', '/i8.jpeg', '/i9.jpeg'];
...
export const DataProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const [services, setServices] = useState<Service[]>(() => {
    ...
    return normalizeServices([
    {
      ...
      image: 'https://i.ibb.co/5MWpVzG/laundry-wash-normal.jpg',
    ...
    },
    {
      ...
      basePrice: 150,
      duration: '5-7 days',
      image: 'https://i.ibb.co/4dXkMdZ/laundry-dry-clean-heavy.jpg',
